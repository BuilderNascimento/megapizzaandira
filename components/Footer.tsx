...
const linkClass =
  "text-white/80 hover:text-orange-400 t-premium";

export function Footer() {
  return (
    <footer className="mt-auto bg-[#1F2937] text-white/80">
      <div className="mx-auto max-w-7xl px-6 py-20">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-5 lg:gap-10">
          <div className="lg:col-span-1">
            <p className="text-xl font-black text-white">{SITE.nome}</p>
            <p className="mt-4 text-sm leading-relaxed text-white/70">
              Pizzaria com inspiração italiana e alma brasileira. Massas
              artesanais, ingredientes frescos e o melhor atendimento em
              Andirá.
            </p>
          </div>
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm">
              ...
              <li>
                <Link href="/cardapio" className={linkClass}>
                  Cardápio
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm">
              ...
              <li className="text-white/70">{SITE.endereco}</li>
            </ul>
          </div>
          <div>
            <p className="text-sm font-bold uppercase tracking-wider text-gold">
            ...
            <div className="mt-4 flex gap-4">
              <a
                ...
                className="text-white hover:text-orange-400 t-premium"
